; ModuleID = 'C:/Users/User/Desktop/UNI/DELFT/Reconfigurable_Computing/LAB/LAB_2/solution2/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_invstripe_ir(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %src, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %dst, float %f) local_unnamed_addr #0 {
entry:
  %src_copy.data = alloca i32
  %src_copy.keep = alloca i4
  %src_copy.strb = alloca i4
  %src_copy.user = alloca i1
  %src_copy.last = alloca i1
  %src_copy.id = alloca i1
  %src_copy.dest = alloca i1
  %dst_copy.data = alloca i32
  %dst_copy.keep = alloca i4
  %dst_copy.strb = alloca i4
  %dst_copy.user = alloca i1
  %dst_copy.last = alloca i1
  %dst_copy.id = alloca i1
  %dst_copy.dest = alloca i1
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull %src, i32* %src_copy.data, i4* %src_copy.keep, i4* %src_copy.strb, i1* %src_copy.user, i1* %src_copy.last, i1* %src_copy.id, i1* %src_copy.dest, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull %dst, i32* %dst_copy.data, i4* %dst_copy.keep, i4* %dst_copy.strb, i1* %dst_copy.user, i1* %dst_copy.last, i1* %dst_copy.id, i1* %dst_copy.dest)
  call void @apatb_invstripe_hw(i32* %src_copy.data, i4* %src_copy.keep, i4* %src_copy.strb, i1* %src_copy.user, i1* %src_copy.last, i1* %src_copy.id, i1* %src_copy.dest, i32* %dst_copy.data, i4* %dst_copy.keep, i4* %dst_copy.strb, i1* %dst_copy.user, i1* %dst_copy.last, i1* %dst_copy.id, i1* %dst_copy.dest, float %f)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %src, i32* %src_copy.data, i4* %src_copy.keep, i4* %src_copy.strb, i1* %src_copy.user, i1* %src_copy.last, i1* %src_copy.id, i1* %src_copy.dest, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %dst, i32* %dst_copy.data, i4* %dst_copy.keep, i4* %dst_copy.strb, i1* %dst_copy.user, i1* %dst_copy.last, i1* %dst_copy.id, i1* %dst_copy.dest)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.83"(i32* %_V_data_V, i4* %_V_keep_V, i4* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.83"(i32* %_V_data_V1, i4* %_V_keep_V2, i4* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %1)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.78"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull align 512 %dst, i32* %src_V_data_V, i4* %src_V_keep_V, i4* %src_V_strb_V, i1* %src_V_user_V, i1* %src_V_last_V, i1* %src_V_id_V, i1* %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.78"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nocapture align 512, i32* noalias nocapture "unpacked"="1.0" %_V_data_V, i4* noalias nocapture "unpacked"="1.1" %_V_keep_V, i4* noalias nocapture "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture "unpacked"="1.3" %_V_user_V, i1* noalias nocapture "unpacked"="1.4" %_V_last_V, i1* noalias nocapture "unpacked"="1.5" %_V_id_V, i1* noalias nocapture "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.83"(i32* noalias "unpacked"="0.0" %dst_V_data_V, i4* noalias "unpacked"="0.1" %dst_V_keep_V, i4* noalias "unpacked"="0.2" %dst_V_strb_V, i1* noalias "unpacked"="0.3" %dst_V_user_V, i1* noalias "unpacked"="0.4" %dst_V_last_V, i1* noalias "unpacked"="0.5" %dst_V_id_V, i1* noalias "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias %src) unnamed_addr #3 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.86"(i32* %dst_V_data_V, i4* %dst_V_keep_V, i4* %dst_V_strb_V, i1* %dst_V_user_V, i1* %dst_V_last_V, i1* %dst_V_id_V, i1* %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.86"(i32* noalias nocapture "unpacked"="0.0" %_V_data_V, i4* noalias nocapture "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"
...
declare void @apatb_invstripe_hw(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, float)
...
define void @invstripe_hw_stub_wrapper(i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, float) #5 {
entry:
  %15 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"
  %16 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %15, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %16, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  call void @invstripe_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %15, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %16, float %14)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %15, i32* %0, i4* %1, i4* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %16, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13)
  ret void
}

declare void @invstripe_hw_stub(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"*, float)
