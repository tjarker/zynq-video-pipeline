...
# 4 "PYNQ-Z2/hls/invstripe.cpp" 2
# 15 "PYNQ-Z2/hls/invstripe.cpp"
typedef ap_axiu<32,1,1,1> pixel_data;
typedef hls::stream<pixel_data> pixel_stream;
typedef ap_fixed<16, 8> fixed_t;

__attribute__((sdx_kernel("invstripe", 0))) void invstripe (pixel_stream &src, pixel_stream &dst, float f)
{
#line 23 "C:/Users/User/Desktop/UNI/DELFT/Reconfigurable_Computing/LAB/LAB_2/solution2/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=invstripe
# 20 "PYNQ-Z2/hls/invstripe.cpp"

#line 7 "C:/Users/User/Desktop/UNI/DELFT/Reconfigurable_Computing/LAB/LAB_2/solution2/directives.tcl"
#pragma HLSDIRECTIVE TOP name=invstripe
# 20 "PYNQ-Z2/hls/invstripe.cpp"
...
#line 8 "C:/Users/User/Desktop/UNI/DELFT/Reconfigurable_Computing/LAB/LAB_2/solution2/directives.tcl"
#pragma HLSDIRECTIVE RESET variable=hist
# 29 "PYNQ-Z2/hls/invstripe.cpp"

#line 9 "C:/Users/User/Desktop/UNI/DELFT/Reconfigurable_Computing/LAB/LAB_2/solution2/directives.tcl"
#pragma HLSDIRECTIVE ARRAY_PARTITION complete dim=1 variable=hist
# 29 "PYNQ-Z2/hls/invstripe.cpp"
  ...
  src >> p;
  r_in = ((p.data)&0xFF);
  b_in = (((p.data)&0xFF0000)>>16);
  g_in = (((p.data)&0xFF00)>>8);
  ...
  if(y < 720 - 1){
   ...
   uint32_t d = ((r_out)&0xFF) | (((g_out)&0xFF)<<8) | (((b_out)&0xFF)<<16);
   p.data = d;
  }
  ...
  if(y == 720 - 1){
   ...
   if(x >= 1280 - 257 and x < 1280 - 129 and stop != 231){
    counter = x - 1280 + 257;
